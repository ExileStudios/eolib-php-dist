...
use Eolib\Protocol\Pub\Server\DropNpcRecord;
...
class DropFile
{
    ...
    /** @return DropNpcRecord[] */
    public function getNpcs(): array
    {
        return $this->npcs;
    }

    /** @param DropNpcRecord[] $npcs */
    ...
    public static function serialize(EoWriter $writer, DropFile $data): void {
        ...
        {
            DropNpcRecord::serialize($writer, $data->getNpcs()[$i]);
    ...
    public function __toString(): string {
        return "DropFile(byteSize=$this->byteSize, npcs=".var_export($this->npcs, true).")";
    }
