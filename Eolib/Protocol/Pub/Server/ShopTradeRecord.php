...
class ShopTradeRecord
{
    ...
    public static function serialize(EoWriter $writer, ShopTradeRecord $data): void {
        ...
        $writer->addChar($data->getMaxAmount());
    ...
    public static function deserialize(EoReader $reader): ShopTradeRecord
    {
        ...
        try {
            ...
            $data->setMaxAmount($reader->getChar());
    ...
    public function __toString(): string {
        return "ShopTradeRecord(byteSize=$this->byteSize, itemId=".var_export($this->itemId, true).", buyPrice=".var_export($this->buyPrice, true).", sellPrice=".var_export($this->sellPrice, true).", maxAmount=".var_export($this->maxAmount, true).")";
    }
