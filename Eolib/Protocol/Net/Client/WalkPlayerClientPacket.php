...
class WalkPlayerClientPacket
{
    ...
    {
        WalkPlayerClientPacket::serialize($writer, $this);
    }
     ...
     * @param WalkPlayerClientPacket $data The data to serialize.
     */
    public static function serialize(EoWriter $writer, WalkPlayerClientPacket $data): void {
     ...
     * @return WalkPlayerClientPacket The deserialized data.
     */
    public static function deserialize(EoReader $reader): WalkPlayerClientPacket
    {
        $data = new WalkPlayerClientPacket();
    ...
    public function __toString(): string {
        return "WalkPlayerClientPacket(byteSize=$this->byteSize, walkAction=".var_export($this->walkAction, true).")";
    }
