...
class ChairRequestClientPacket
{
    ...
    public function __toString(): string {
        return "ChairRequestClientPacket(byteSize=$this->byteSize, sitAction=".var_export($this->sitAction, true).", sitActionData=".var_export($this->sitActionData, true).")";
    }
...
class SitActionDataSit implements SitActionData
{
     ...
     */
    public function __toString(): string {
        return "SitActionDataSit(byteSize=$this->byteSize, coords=".var_export($this->coords, true).")";
    }
