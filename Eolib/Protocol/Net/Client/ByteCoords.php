...
class ByteCoords
{
    ...
    public static function serialize(EoWriter $writer, ByteCoords $data): void {
        ...
        $writer->addByte($data->getX());

        if ($data->getY() == null)
        {
            throw new SerializationError('y must be provided.');
        }
        $writer->addByte($data->getY());
    ...
    public static function deserialize(EoReader $reader): ByteCoords
    {
        ...
        try {
            ...
            $data->setX($reader->getByte());
            $data->setY($reader->getByte());
    ...
    public function __toString(): string {
        return "ByteCoords(byteSize=$this->byteSize, x=".var_export($this->x, true).", y=".var_export($this->y, true).")";
    }
