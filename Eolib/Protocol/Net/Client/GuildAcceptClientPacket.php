...
class GuildAcceptClientPacket
{
    ...
    {
        GuildAcceptClientPacket::serialize($writer, $this);
    }
     ...
     * @param GuildAcceptClientPacket $data The data to serialize.
     */
    public static function serialize(EoWriter $writer, GuildAcceptClientPacket $data): void {
        $writer->addInt(20202);
     ...
     * @return GuildAcceptClientPacket The deserialized data.
     */
    public static function deserialize(EoReader $reader): GuildAcceptClientPacket
    {
        $data = new GuildAcceptClientPacket();
    ...
    public function __toString(): string {
        return "GuildAcceptClientPacket(byteSize=$this->byteSize, inviterPlayerId=".var_export($this->inviterPlayerId, true).")";
    }
