...
class PlayersAgreeServerPacket
{
    ...
    {
        PlayersAgreeServerPacket::serialize($writer, $this);
    }
     ...
     * @param PlayersAgreeServerPacket $data The data to serialize.
     */
    public static function serialize(EoWriter $writer, PlayersAgreeServerPacket $data): void {
     ...
     * @return PlayersAgreeServerPacket The deserialized data.
     */
    public static function deserialize(EoReader $reader): PlayersAgreeServerPacket
    {
        $data = new PlayersAgreeServerPacket();
    ...
    public function __toString(): string {
        return "PlayersAgreeServerPacket(byteSize=$this->byteSize, nearby=".var_export($this->nearby, true).")";
    }
