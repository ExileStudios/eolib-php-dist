...
class WelcomePingServerPacket
{
    ...
    {
        WelcomePingServerPacket::serialize($writer, $this);
    }
     ...
     * @param WelcomePingServerPacket $data The data to serialize.
     */
    public static function serialize(EoWriter $writer, WelcomePingServerPacket $data): void {
     ...
     * @return WelcomePingServerPacket The deserialized data.
     */
    public static function deserialize(EoReader $reader): WelcomePingServerPacket
    {
        $data = new WelcomePingServerPacket();
    ...
    public function __toString(): string {
        return "WelcomePingServerPacket(byteSize=$this->byteSize, mapFile=".var_export($this->mapFile, true).")";
    }
