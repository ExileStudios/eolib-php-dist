...
class TalkTellServerPacket
{
    ...
    {
        TalkTellServerPacket::serialize($writer, $this);
    }
     ...
     * @param TalkTellServerPacket $data The data to serialize.
     */
    public static function serialize(EoWriter $writer, TalkTellServerPacket $data): void {
     ...
     * @return TalkTellServerPacket The deserialized data.
     */
    public static function deserialize(EoReader $reader): TalkTellServerPacket
    {
        $data = new TalkTellServerPacket();
    ...
    public function __toString(): string {
        return "TalkTellServerPacket(byteSize=$this->byteSize, playerName=$this->playerName, message=$this->message)";
    }
