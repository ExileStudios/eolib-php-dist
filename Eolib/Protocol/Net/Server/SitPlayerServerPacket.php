...
class SitPlayerServerPacket
{
    ...
    {
        SitPlayerServerPacket::serialize($writer, $this);
    }
     ...
     * @param SitPlayerServerPacket $data The data to serialize.
     */
    public static function serialize(EoWriter $writer, SitPlayerServerPacket $data): void {
     ...
     * @return SitPlayerServerPacket The deserialized data.
     */
    public static function deserialize(EoReader $reader): SitPlayerServerPacket
    {
        $data = new SitPlayerServerPacket();
    ...
    public function __toString(): string {
        return "SitPlayerServerPacket(byteSize=$this->byteSize, playerId=".var_export($this->playerId, true).", coords=".var_export($this->coords, true).", direction=".var_export($this->direction, true).")";
    }
