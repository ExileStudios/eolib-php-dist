...
class ChairPlayerServerPacket
{
    ...
    {
        ChairPlayerServerPacket::serialize($writer, $this);
    }
     ...
     * @param ChairPlayerServerPacket $data The data to serialize.
     */
    public static function serialize(EoWriter $writer, ChairPlayerServerPacket $data): void {
     ...
     * @return ChairPlayerServerPacket The deserialized data.
     */
    public static function deserialize(EoReader $reader): ChairPlayerServerPacket
    {
        $data = new ChairPlayerServerPacket();
    ...
    public function __toString(): string {
        return "ChairPlayerServerPacket(byteSize=$this->byteSize, playerId=".var_export($this->playerId, true).", coords=".var_export($this->coords, true).", direction=".var_export($this->direction, true).")";
    }
