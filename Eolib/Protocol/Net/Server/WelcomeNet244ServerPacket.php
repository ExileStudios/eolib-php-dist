...
class WelcomeNet244ServerPacket
{
    ...
    {
        WelcomeNet244ServerPacket::serialize($writer, $this);
    }
     ...
     * @param WelcomeNet244ServerPacket $data The data to serialize.
     */
    public static function serialize(EoWriter $writer, WelcomeNet244ServerPacket $data): void {
     ...
     * @return WelcomeNet244ServerPacket The deserialized data.
     */
    public static function deserialize(EoReader $reader): WelcomeNet244ServerPacket
    {
        $data = new WelcomeNet244ServerPacket();
    ...
    public function __toString(): string {
        return "WelcomeNet244ServerPacket(byteSize=$this->byteSize, pubFile=".var_export($this->pubFile, true).")";
    }
