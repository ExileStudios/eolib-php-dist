...
class EquipmentCharacterSelect
{
     ...
     * @param EquipmentCharacterSelect $data The data to serialize.
     */
    public static function serialize(EoWriter $writer, EquipmentCharacterSelect $data): void {
     ...
     * @return EquipmentCharacterSelect The deserialized data.
     */
    public static function deserialize(EoReader $reader): EquipmentCharacterSelect
    {
        $data = new EquipmentCharacterSelect();
    ...
    public function __toString(): string {
        return "EquipmentCharacterSelect(byteSize=$this->byteSize, boots=".var_export($this->boots, true).", armor=".var_export($this->armor, true).", hat=".var_export($this->hat, true).", shield=".var_export($this->shield, true).", weapon=".var_export($this->weapon, true).")";
    }
