...
class EquipmentPaperdoll
{
    ...
    public function __toString(): string {
        return "EquipmentPaperdoll(byteSize=$this->byteSize, boots=".var_export($this->boots, true).", accessory=".var_export($this->accessory, true).", gloves=".var_export($this->gloves, true).", belt=".var_export($this->belt, true).", armor=".var_export($this->armor, true).", necklace=".var_export($this->necklace, true).", hat=".var_export($this->hat, true).", shield=".var_export($this->shield, true).", weapon=".var_export($this->weapon, true).", ring=".var_export($this->ring, true).", armlet=".var_export($this->armlet, true).", bracer=".var_export($this->bracer, true).")";
    }
