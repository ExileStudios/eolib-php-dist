...
class ArenaSpecServerPacket
{
    ...
    public function __toString(): string {
        return "ArenaSpecServerPacket(byteSize=$this->byteSize, playerId=".var_export($this->playerId, true).", direction=".var_export($this->direction, true).", killsCount=".var_export($this->killsCount, true).", killerName=$this->killerName, victimName=$this->victimName)";
    }
