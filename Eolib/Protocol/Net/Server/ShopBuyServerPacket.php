...
class ShopBuyServerPacket
{
    ...
    public static function serialize(EoWriter $writer, ShopBuyServerPacket $data): void {
        ...
        if ($data->getBoughtItem() == null)
        {
            throw new SerializationError('boughtItem must be provided.');
        }
        Item::serialize($writer, $data->getBoughtItem());
    ...
    public static function deserialize(EoReader $reader): ShopBuyServerPacket
    {
        ...
        try {
            ...
            $data->setBoughtItem(Item::deserialize($reader));
    ...
    public function __toString(): string {
        return "ShopBuyServerPacket(byteSize=$this->byteSize, goldAmount=".var_export($this->goldAmount, true).", boughtItem=".var_export($this->boughtItem, true).", weight=".var_export($this->weight, true).")";
    }
