...
class NpcAcceptServerPacket
{
    ...
    public function __toString(): string {
        return "NpcAcceptServerPacket(byteSize=$this->byteSize, npcKilledData=".var_export($this->npcKilledData, true).", experience=".var_export($this->experience, true).", levelUp=".var_export($this->levelUp, true).")";
    }
