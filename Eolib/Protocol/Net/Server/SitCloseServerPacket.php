...
class SitCloseServerPacket
{
    ...
    {
        SitCloseServerPacket::serialize($writer, $this);
    }
     ...
     * @param SitCloseServerPacket $data The data to serialize.
     */
    public static function serialize(EoWriter $writer, SitCloseServerPacket $data): void {
     ...
     * @return SitCloseServerPacket The deserialized data.
     */
    public static function deserialize(EoReader $reader): SitCloseServerPacket
    {
        $data = new SitCloseServerPacket();
    ...
    public function __toString(): string {
        return "SitCloseServerPacket(byteSize=$this->byteSize, playerId=".var_export($this->playerId, true).", coords=".var_export($this->coords, true).")";
    }
