...
class TradeReplyServerPacket
{
    ...
    {
        TradeReplyServerPacket::serialize($writer, $this);
    }
     ...
     * @param TradeReplyServerPacket $data The data to serialize.
     */
    public static function serialize(EoWriter $writer, TradeReplyServerPacket $data): void {
     ...
     * @return TradeReplyServerPacket The deserialized data.
     */
    public static function deserialize(EoReader $reader): TradeReplyServerPacket
    {
        $data = new TradeReplyServerPacket();
    ...
    public function __toString(): string {
        return "TradeReplyServerPacket(byteSize=$this->byteSize, tradeData=".var_export($this->tradeData, true).")";
    }
