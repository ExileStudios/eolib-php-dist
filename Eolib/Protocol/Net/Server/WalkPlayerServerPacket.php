...
class WalkPlayerServerPacket
{
    ...
    public function __toString(): string {
        return "WalkPlayerServerPacket(byteSize=$this->byteSize, playerId=".var_export($this->playerId, true).", direction=".var_export($this->direction, true).", coords=".var_export($this->coords, true).")";
    }
