...
class CharacterBaseStatsWelcome
{
    ...
    public function __toString(): string {
        return "CharacterBaseStatsWelcome(byteSize=$this->byteSize, str=".var_export($this->str, true).", wis=".var_export($this->wis, true).", intl=".var_export($this->intl, true).", agi=".var_export($this->agi, true).", con=".var_export($this->con, true).", cha=".var_export($this->cha, true).")";
    }
