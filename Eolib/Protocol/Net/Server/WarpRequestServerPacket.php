...
class WarpRequestServerPacket
{
    ...
    public function __toString(): string {
        return "WarpRequestServerPacket(byteSize=$this->byteSize, warpType=".var_export($this->warpType, true).", mapId=".var_export($this->mapId, true).", warpTypeData=".var_export($this->warpTypeData, true).", sessionId=".var_export($this->sessionId, true).")";
    }
...
class WarpTypeDataMapSwitch implements WarpTypeData
{
     ...
     */
    public function __toString(): string {
        return "WarpTypeDataMapSwitch(byteSize=$this->byteSize, mapRid=".var_export($this->mapRid, true).", mapFileSize=".var_export($this->mapFileSize, true).")";
    }
