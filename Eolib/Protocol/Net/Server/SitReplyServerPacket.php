...
class SitReplyServerPacket
{
    ...
    public function __toString(): string {
        return "SitReplyServerPacket(byteSize=$this->byteSize, playerId=".var_export($this->playerId, true).", coords=".var_export($this->coords, true).", direction=".var_export($this->direction, true).")";
    }
