...
class PaperdollAgreeServerPacket
{
    ...
    public static function serialize(EoWriter $writer, PaperdollAgreeServerPacket $data): void {
        ...
        $writer->addThree($data->getRemainingAmount());
    ...
    public static function deserialize(EoReader $reader): PaperdollAgreeServerPacket
    {
        ...
        try {
            ...
            $data->setRemainingAmount($reader->getThree());
    ...
    public function __toString(): string {
        return "PaperdollAgreeServerPacket(byteSize=$this->byteSize, change=".var_export($this->change, true).", itemId=".var_export($this->itemId, true).", remainingAmount=".var_export($this->remainingAmount, true).", subLoc=".var_export($this->subLoc, true).", stats=".var_export($this->stats, true).")";
    }
