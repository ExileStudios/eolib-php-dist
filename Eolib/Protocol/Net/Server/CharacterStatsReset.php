...
class CharacterStatsReset
{
    ...
    public static function serialize(EoWriter $writer, CharacterStatsReset $data): void {
        ...
        CharacterBaseStats::serialize($writer, $data->getBase());
    ...
    public static function deserialize(EoReader $reader): CharacterStatsReset
    {
        ...
        try {
            ...
            $data->setBase(CharacterBaseStats::deserialize($reader));
    ...
    public function __toString(): string {
        return "CharacterStatsReset(byteSize=$this->byteSize, statPoints=".var_export($this->statPoints, true).", skillPoints=".var_export($this->skillPoints, true).", hp=".var_export($this->hp, true).", maxHp=".var_export($this->maxHp, true).", tp=".var_export($this->tp, true).", maxTp=".var_export($this->maxTp, true).", maxSp=".var_export($this->maxSp, true).", base=".var_export($this->base, true).", secondary=".var_export($this->secondary, true).")";
    }
