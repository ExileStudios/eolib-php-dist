...
class EquipmentWelcome
{
    ...
    public function __toString(): string {
        return "EquipmentWelcome(byteSize=' . $this->byteSize . '', boots=' . $this->boots . '', gloves=' . $this->gloves . '', accessory=' . $this->accessory . '', armor=' . $this->armor . '', belt=' . $this->belt . '', necklace=' . $this->necklace . '', hat=' . $this->hat . '', shield=' . $this->shield . '', weapon=' . $this->weapon . '', ring=' . $this->ring . '', armlet=' . $this->armlet . '', bracer=' . $this->bracer . ')";
    }
