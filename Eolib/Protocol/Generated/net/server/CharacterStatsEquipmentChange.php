...
class CharacterStatsEquipmentChange
{
    ...
    public function __toString(): string {
        return "CharacterStatsEquipmentChange(byteSize=' . $this->byteSize . '', maxHp=' . $this->maxHp . '', maxTp=' . $this->maxTp . '', baseStats=' . $this->baseStats . '', secondaryStats=' . $this->secondaryStats . ')";
    }
