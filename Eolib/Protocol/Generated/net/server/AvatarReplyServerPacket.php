...
class AvatarReplyServerPacket
{
    ...
    public function __toString(): string {
        return "AvatarReplyServerPacket(byteSize=' . $this->byteSize . '', playerId=' . $this->playerId . '', victimId=' . $this->victimId . '', damage=' . $this->damage . '', direction=' . $this->direction . '', hpPercentage=' . $this->hpPercentage . '', dead=' . $this->dead . ')";
    }
