...
class BankReplyServerPacket
{
    ...
    public static function deserialize(EoReader $reader): BankReplyServerPacket
    {
        ...
        try {
            ...
            $data->goldInventory = $reader->getInt();
    ...
    public function __toString(): string {
        return "BankReplyServerPacket(byteSize=' . $this->byteSize . '', goldInventory=' . $this->goldInventory . '', goldBank=' . $this->goldBank . ')";
    }
