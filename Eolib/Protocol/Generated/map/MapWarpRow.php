...
use Eolib\Protocol\Generated\Map\MapWarpRowTile;
...
class MapWarpRow
{
    ...
    public static function serialize(EoWriter $writer, MapWarpRow $data): void {
        ...
        {
            MapWarpRowTile::serialize($writer, $data->tiles[$i]);
    ...
    public function __toString(): string {
        return "MapWarpRow(byteSize=' . $this->byteSize . '', y=' . $this->y . '', tiles=' . $this->tiles . ')";
    }
