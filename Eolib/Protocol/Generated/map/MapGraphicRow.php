...
use Eolib\Protocol\Generated\Map\MapGraphicRowTile;
...
class MapGraphicRow
{
    ...
    public static function serialize(EoWriter $writer, MapGraphicRow $data): void {
        ...
        {
            MapGraphicRowTile::serialize($writer, $data->tiles[$i]);
    ...
    public function __toString(): string {
        return "MapGraphicRow(byteSize=' . $this->byteSize . '', y=' . $this->y . '', tiles=' . $this->tiles . ')";
    }
